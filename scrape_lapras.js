...
(async () => {
  ...
  // 3. GENERATE FULL CARD AS A STANDALONE SVG IMAGE WITH INTERACTION
  ...
  // 5. INJECT CLEAN IMG TAG INTO README.MD
  ...
  console.log('Successfully updated lapras-card.svg and README.md!');
